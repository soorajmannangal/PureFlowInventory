...
namespace PureFlow
{
    ...
    public interface IDataSource
    {
        ...
        List<ServiceRequestGridDto> GetServiceRequestList(string v1, string v2, string v3, string v4, string v5, string v6, string v7, string v8, string v9, string orderBy);
